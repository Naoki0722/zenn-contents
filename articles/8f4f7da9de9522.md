...
そのあとは、 `node_modules/react-hook-form/dist/types/form.d.ts` の中を見る！
...
pattern があって正規表現も対応しているので、大体のフォームには対応できるかと思います。
...
※そもそも、React における ref というのは、ちょっと難しいところなので別途解説しようと思います...
